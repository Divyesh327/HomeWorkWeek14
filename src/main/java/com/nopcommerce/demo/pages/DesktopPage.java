...
public class DesktopPage extends Utility
{
    ...
    public void ascendingOrder() throws InterruptedException {
        ...
        Assert.assertEquals("Build your own computer text does not match....", expectedMessage1, actualMessage1);
        ...
        Assert.assertEquals("The Price is not Matching", expectedMessage2, actualMessage2);
        ...
        Assert.assertEquals("The Product is not added to Shopping Cart", expectedMessage3, actualMessage3);
